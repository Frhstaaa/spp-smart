...
export default function Create({ auth }) {
    ...
    return (
        <MainLayout user={auth.user} header={<h2 className="font-bold text-2xl text-slate-800 dark:text-slate-200">Tambah Pengguna</h2>}>
            ...
            <div className="py-2 md:py-8">
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    <div className="mb-6 flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 dark:text-white">Form Pengguna Baru</h3>
                            <p className="text-sm text-slate-500 dark:text-slate-400">Buat akun untuk staf, guru, atau yayasan.</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700/50 overflow-hidden">
                        <form onSubmit={submit} className="p-6 md:p-8 space-y-6">
                            ...
                            <div className="border-t border-slate-200 dark:border-slate-700 pt-6 mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                {/* Password */}
                                <div className="space-y-2">
                                    <InputLabel htmlFor="password" value="Password" className="text-slate-700 dark:text-slate-300" />
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                ...
                                {/* Confirm Password */}
                                <div className="space-y-2">
                                    <InputLabel htmlFor="password_confirmation" value="Konfirmasi Password" className="text-slate-700 dark:text-slate-300" />
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <KeyIcon className="h-5 w-5 text-slate-400" />
                                        </div>
